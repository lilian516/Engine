...
void PenMesh::buildGeometry(ID3D12Device* device, ID3D12GraphicsCommandList* commandList) {
	std::vector<Vertex> vertices =
	{
		...
		Vertex({ XMFLOAT3(-0.5f, 0.5f, 0.5f), XMFLOAT4(Colors::White),XMFLOAT2(1,1) }),//24
		Vertex({ XMFLOAT3(0.5f, 0.5f, 0.5f), XMFLOAT4(Colors::White),XMFLOAT2(0,1) }),//25
		Vertex({ XMFLOAT3(0.0f, 1.5f, 0.0f), XMFLOAT4(Colors::Blue),XMFLOAT2(1,0) }),//26

		Vertex({ XMFLOAT3(0.5f, 0.5f, 0.5f), XMFLOAT4(Colors::White),XMFLOAT2(1,1)}),//27
		Vertex({ XMFLOAT3(0.5f, 0.5f, -0.5f), XMFLOAT4(Colors::White),XMFLOAT2(0,1) }),//28
		Vertex({ XMFLOAT3(0.0f, 1.5f, 0.0f), XMFLOAT4(Colors::Blue),XMFLOAT2(1,0) }),//29

		Vertex({ XMFLOAT3(-0.5f, 0.5f, -0.5f), XMFLOAT4(Colors::White),XMFLOAT2(1,1)}),//30
		Vertex({ XMFLOAT3(-0.5f, 0.5f, 0.5f), XMFLOAT4(Colors::White),XMFLOAT2(0,1) }),//31
		Vertex({ XMFLOAT3(0.0f, 1.5f, 0.0f), XMFLOAT4(Colors::Blue),XMFLOAT2(0,0) }),//32

		Vertex({ XMFLOAT3(-0.5f, 0.5f, -0.5f), XMFLOAT4(Colors::White),XMFLOAT2(0,1)}),//33
		Vertex({ XMFLOAT3(0.5f, 0.5f, -0.5f), XMFLOAT4(Colors::White),XMFLOAT2(1,1) }),//34
		Vertex({ XMFLOAT3(0.0f, 1.5f, 0.0f), XMFLOAT4(Colors::Blue),XMFLOAT2(1,0) }),//35
